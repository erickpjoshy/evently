...
const Card = ({event , hasOrderLink,hidePrice}:CardProps) => {
  ...
  return (
    <div className='group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]'>
        ...
        style={{backgroundImage : `url(${event.imageUrl})`}} className='flex-center flex-grow bg-gray-50 bg-cover bg-center text-grey-500' />
          {/* is Event Creator */}
          {isEventCreator && !hidePrice &&(
            <div className='absolute right-2 top-2 flex flex-col gap-4 rounded-xl shadow-sm bg-white transition-all p-3'>
